...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('.text-component.style-10', { style: 'fade-up', speed: 1000, intensity: 10, threshold: 1, delay: 250, replay: false });
		onvisible.add('.buttons-component.style-1', { style: 'fade-in', speed: 1625, intensity: 5, threshold: 1, delay: 0, replay: false });
		onvisible.add('.list-component.style-2', { style: 'fade-up', speed: 750, intensity: 5, threshold: 2, delay: 0, stagger: 125, staggerSelector: ':scope > ul > li, :scope > ol > li', replay: false });
